...
public class Fragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        NetworkTask networkTask = new NetworkTask("http://172.30.1.20:8008/checkbox", values);
        networkTask.execute();
        ...
        btnModify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!name.equals("") && !tel.equals("") && !address1.equals("") && !address2.equals("")){
                    ...
                    Fragment3.NetworkTask networkTask = new Fragment3.NetworkTask("http://172.30.1.20:8008/userinfo", values);
                    networkTask.execute();
